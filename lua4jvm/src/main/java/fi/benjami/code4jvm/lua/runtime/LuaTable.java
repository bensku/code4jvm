...
public class LuaTable {
	...
	public Object get(Object key) {
		...
		if (index instanceof LuaTable table) {
			...
			var target = LuaLinker.linkCall(new LuaCallSite(null, types), types, index, this, key);
			try {
	...
	public void set(Object key, Object value) {
		if (metatable != null && getRaw(key) == null) {
			...
			if (newIndex instanceof LuaTable table) {
				...
				var target = LuaLinker.linkCall(new LuaCallSite(null, types), types, newIndex, this, key, value);
				try {
